    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 sm:px-6">
      ...
      <div className="absolute top-4 sm:top-6 left-4 sm:left-6 z-20">
        <img 
          ...
          alt="Cold AI"
          className="h-24 sm:h-32 md:h-40 w-auto hover:scale-105 transition-transform cursor-pointer"
      ...
      <div className="relative z-10 text-center space-y-6 sm:space-y-8 max-w-5xl mx-auto">
        ...
        <div className="flex justify-center mb-6 sm:mb-8">
          <div className="relative group">
            ...
            <div className="relative">
              <div className="relative w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl flex items-center justify-center transform hover:scale-110 transition-all duration-500 shadow-2xl border border-gray-700">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight leading-tight">
            ...
            <div className="relative inline-block min-h-[1.2em] w-full sm:w-auto">
              {headlines.map((headline, index) => (
                <div
                  key={index}
                  className={cn(
                    "absolute top-0 left-0 w-full sm:w-auto transition-all duration-700 ease-in-out",
                    index === headlineIndex 
        ...
        <div className="pt-12 sm:pt-16 space-y-4 sm:space-y-6">
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <ShimmerButton
              className="shadow-2xl relative group w-full sm:w-auto"
